...
class RestaurantCSV(models.Model):
    ...
    month_nm = models.CharField(max_length=256)
    quarter = models.CharField(max_length=256)
    year_month = models.CharField(max_length=256)
    week = models.CharField(max_length=256)
    week_ending_mon_sun_dt = models.DateField()
    min_order_datetime = models.DateField()
    kpi = models.CharField(max_length=256)
    menu_category = models.CharField(max_length=256)
    menu_group = models.CharField(max_length=256)
    menu_item = models.CharField(max_length=256)
